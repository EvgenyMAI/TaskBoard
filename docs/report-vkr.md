...
Рисунок 5 — Экран входа/главной страницы после авторизации.

![Создание и управление проектами](screenshots/04-projects-create.png)

Рисунок 6 — Работа с проектами.

![Создание задач](screenshots/09-tasks-create.png)

Рисунок 7 — Создание и просмотр задач.

![Карточка задачи](screenshots/12-task-detail.png)

Рисунок 8 — Карточка задачи: просмотр и редактирование, вкладки комментариев, вложений и истории.

![Уведомления](screenshots/15-notifications.png)

Рисунок 9 — Раздел уведомлений.
