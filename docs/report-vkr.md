...
3. Увеличение покрытия тестами (unit/integration/e2e).
4. Подготовка финальной документации в формате, соответствующем требованиям ГОСТ (титульный лист, оформление рисунков/таблиц, параметры шрифта и межстрочного интервала).
