...
1. Углубление ролевой модели и прав доступа на уровне бизнес-операций.
2. Расширение аналитики и отчетности на основе фактических данных задач.
3. Развитие модуля уведомлений (в том числе переход к realtime-механизму доставки).
4. Реализация полноценной загрузки и хранения файлов вложений.
5. Увеличение покрытия тестами (unit/integration/e2e).
6. Подготовка финальной документации в формате, соответствующем требованиям ГОСТ (титульный лист, оформление рисунков/таблиц, параметры шрифта и межстрочного интервала).
