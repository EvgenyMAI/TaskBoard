...
Страница аналитики оформлена в едином стиле с профилем и уведомлениями (hero-блок с чипом выбранного периода, секции с маркерами разделов): выбор интервала `from`/`to`, пресеты длительности, выгрузка CSV, сводные KPI, динамика периода, распределение статусов с переключением вида (кольцо или столбцы), топы проектов и исполнителей.
