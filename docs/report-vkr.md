...
1. Развитие модуля уведомлений (в том числе переход к realtime-механизму доставки).
2. Увеличение покрытия тестами (unit/integration/e2e).
3. Подготовка финальной документации в формате, соответствующем требованиям ГОСТ (титульный лист, оформление рисунков/таблиц, параметры шрифта и межстрочного интервала).
